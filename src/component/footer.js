    ...
    return (
      <React.Fragment>
        <footer style={{ background: "#778899" }} id="contact">
          ...
          <Container fluid style={{ background: "#e6e9f0" }}>
            <Container>
              ...
              <Row>
                ...
                <Col xs="12" sm="4" md="4" lg="4">
                  ...
                  <p>
                    Phone: <a href="tel:+917505947871">+91 75059 47871</a>
                  </p>
                  <p>
                    Email:{" "}
                    <a href="mailto:ramdayal.natuiyal@gmail.com">
                      ramdayal.nautiyal@gmail.com
                    </a>
                  </p>
                </Col>
              </Row>
          ...
          <Container
            fluid
            style={{ background: "#004085d4 ", color: "#e6e6fa !important" }}
          >
            <span
              className="animate_copyright"
              style={{
                display: "flex",
              ...
              animateCopyright={this.animateCopyright}
            >
              copyright to Ashish Nautiyal
            </span>
          </Container>
        </footer>
      </React.Fragment>
